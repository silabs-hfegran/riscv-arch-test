...
pushd core-v-verif/cv32e40s/sim/uvmt
...
pushd riscv-compliance
    ...
    make RISCV_TARGET=cv32e40s RISCV_ISA=rv32i_m RISCV_DEVICE=I
    make RISCV_TARGET=cv32e40s RISCV_ISA=rv32i_m RISCV_DEVICE=M
    make RISCV_TARGET=cv32e40s RISCV_ISA=rv32i_m RISCV_DEVICE=C
    make RISCV_TARGET=cv32e40s RISCV_ISA=rv32i_m RISCV_DEVICE=Zifencei
    make RISCV_TARGET=cv32e40s RISCV_ISA=rv32i_m RISCV_DEVICE=privilege
popd
